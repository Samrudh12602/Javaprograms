...
class GFG {
    ...
    {
        Bank obj = new Bank();
        ThreadWithdrawal t1 = new ThreadWithdrawal(obj, "Nidhi", 20);
        ThreadWithdrawal t2 = new ThreadWithdrawal(obj, "Edgar", 40);
        ThreadDeposit t3 = new ThreadDeposit(obj, "Samrudh", 50);
        ThreadWithdrawal t4 = new ThreadWithdrawal(obj, "Shantaksh", 80);
        ThreadWithdrawal t5 = new ThreadWithdrawal(obj, "Gaurav", 40);
        t1.start();
        t2.start();
        t3.start();
        t4.start();
